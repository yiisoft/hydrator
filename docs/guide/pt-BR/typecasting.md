...
parameter, for example, `а..я`. It works both in the default and in the
multibyte mode. This syntax is deprecated and will be removed in the next
major version, so avoid it in new code.
