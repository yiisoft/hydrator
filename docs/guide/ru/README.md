...
Пакет предназначен для создания и гитратации (насыщения, заполнения) объектов из набора "сырых" данных.
...
- [Фабрика преобразования атрибутов](attribute-resolver-factory.md)
