...
Кроме того, можно указать, как атрибуты внешнего источника сопоставляются с гидрируемым классом.
...
Например, давайте создадим атрибут свойства, который возвращает случайное значение для свойства объекта.
