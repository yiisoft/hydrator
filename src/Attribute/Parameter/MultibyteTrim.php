...
/**
 * Multibyte-aware version of {@see Trim}. It strips whitespace (or other characters) from the beginning and end of
...
final class MultibyteTrim implements ParameterAttributeInterface
{
    /**
     * @param string|null $characters The list of all characters that you want to be stripped. Unlike {@see Trim},
    ...
    {
        return MultibyteTrimResolver::class;
    }
}
